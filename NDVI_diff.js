//VERSION=3
// Script to extract NDVI difference between the latest acquisition and the acquisition numDays prior to the latest within a specified time range
...
function preProcessScenes(collections) {
    ...
    // timestamp of numDays prior to latest acquisition
	var numDays = 1460
    let target = new Date(new Date(latest.dateFrom).getTime() - numDays * 24 * 3600 * 1000);
